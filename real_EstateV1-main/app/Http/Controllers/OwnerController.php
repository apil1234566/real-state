...
class OwnerController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->upload_path = public_path("images/owner/profile/");
        $this->width = 600;
        $this->height = 800;
    ...
    public function profile()
    {
        ...
        return view('Backend.owner.profile')->with(compact('user', 'owner', 'cities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('profile_image') && $owner) {
