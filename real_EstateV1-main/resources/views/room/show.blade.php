                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-collapse pb-5">
                                        @foreach($room->upload_groups as $upload_groups)
                                            <a href="<?= route('/') . '/app/' . $upload_groups->upload->filepath . '/' . $upload_groups->upload->filename ?>" target="_blank">
                                                <img src="<?= '/app/' . $upload_groups->upload->filepath . '/' . $upload_groups->upload->filename ?>" height="80px" width="200px" class="mb-1">
                                            </a><br>
                                        @endforeach
                                    </div>
