                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <img src="{{ (($seeker->image != '') && file_exists(public_path('images/seeker/profile/'.$seeker->image))) ? asset('images/seeker/profile/'.$seeker->image) : asset('backend/assets/img/logo.jpg') }}" alt="" class="" style="width:200px;height:200px;object-fit:cover; border: 1px solid #cccccc">
