        ...
        <div class="col-12 p-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 nodecorationlist">
                    ...
                    <li class="breadcrumb-item active gray" aria-current="page">Search Property</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        if (data.success == true) {
                            ...
                            $.each(properties, function (key, property) {
                                ...
                                $.each(properties, function (key, property) {
                                    ...
                                    var resulttag = '<td>' + property.title + '</td>' +
                                        '<td>' + property.city.name + '</td>' +
                                        '<td>' + property.place.name + '</td>' +
                                        '<td>' + property.created_at + '</td>' +
                                        '<td class="d-inline-flex">' +
                                        '<a href="/property/show/' + property.id +'"'+ 'class="pt-1 pl-1""><i class="far fa-eye"></i></a>'
                                        + '</td>';
