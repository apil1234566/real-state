...
<div class="container-fluid pl-3 pr-3">
        ...
        <div class="col-12 p-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 nodecorationlist">
                    ...
                    <li class="breadcrumb-item green"><a href="{{route('seeker_room')}}" class="green">All Properties</a>
                    </li>
                    <li class="breadcrumb-item active gray" aria-current="page">Recomended Properties</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Recomendation
                    </div>
                    ...
                    <div class="card-body mt-0">
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped table-hover table-responsive-sm table-sm">
                                ...
                                <tbody>
                                    @foreach ($recomend_properties as $property)

                                    <tr>
                                        <td>{{$property->titleLimit}}</td>
