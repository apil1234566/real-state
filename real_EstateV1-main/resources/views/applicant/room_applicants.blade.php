            ...
            <div class="col-12 p-0">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 nodecorationlist">
                        ...
                        <li class="breadcrumb-item active gray" aria-current="page">View Application</li>
                    </ol>
                </nav>
            </div>
        </div>
                                            ...
                                            @forelse($applicants as $applicant)
                                                <tr>
                                                    ...
                                                    @if($applicant->status == 'approved')
                                                        ...
                                                        <strong>Accepted</strong></span></h4>
                                                        </td>
                                                    ...
                                                    @elseif($applicant->status == 'pending')
                                                        @if($hired_status == 0)
                                                            <td>
                                                                <a href="{{route('applicant.hire',['user_id'=>$applicant->user_id,'property_id' =>$property_id])}}"
                                                                   class="btn btn-sm btn-outline-success mb-3">
                                                                    <i class="fas fa-thumbs-up"></i> Accept Inivitation
                                                                </a>

                                                                <a href="{{route('applicant.reject',['user_id'=>$applicant->user_id,'property_id' =>$property_id])}}"
                                                                   class="btn btn-sm btn-outline-danger mb-3">
                                                                    <i class="far fa-thumbs-down"></i> Reject Invetation
                                                                </a>
                                                            </td>
                                                        @endif
