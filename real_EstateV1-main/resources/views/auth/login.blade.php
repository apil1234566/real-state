...
<head>
    <link rel="shortcut icon" href="{{ asset('backend/assets/img/logo.jpg') }}" type="image/x-icon" style="height: 50px;">
    <link rel="icon" href="{{ asset('backend/assets/img/logo.jpg') }}" type="image/x-icon">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-10">
            <div class="text-center">
                <img src="{{ asset('backend/assets/img/logo.jpg') }}" width="100px" height="70px" alt="" class="pt-0">
                <h5 class="gray">
                    Login
                </h5>
            </div>
                    ...
                    <div class="card-body mt-3">
                        <form class="custom-hover" action="{{ route('login') }}" method="POST" id="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                     <a href="{{ route('register') }}" class="gray" style="text-decoration:none">
                                         Sign up
                                     </a>
                                </div>
                            </div>
